...
pub const REASON_FETCH_BN_ERROR: Reason = Reason {
    code: "fetch_bn_error",
...
/// failed.
pub const REASON_MISSING_AGGREGATOR_ATTESTATION: Reason = Reason {
...
/// selections.
pub const REASON_INSUFFICIENT_AGGREGATOR_SELECTIONS: Reason = Reason {
...
/// submitted.
pub const REASON_ZERO_AGGREGATOR_SELECTIONS: Reason = Reason {
...
pub const REASON_FAILED_AGGREGATOR_SELECTION: Reason = Reason {
...
/// received.
pub const REASON_NO_AGGREGATOR_SELECTIONS: Reason = Reason {
...
/// cluster.
pub const REASON_PROPOSER_INSUFFICIENT_RANDAOS: Reason = Reason {
...
pub const REASON_PROPOSER_ZERO_RANDAOS: Reason = Reason {
...
pub const REASON_FAILED_PROPOSER_RANDAO: Reason = Reason {
...
pub const REASON_PROPOSER_NO_EXTERNAL_RANDAOS: Reason = Reason {
...
pub const REASON_SYNC_CONTRIBUTION_NO_SYNC_MSG: Reason = Reason {
...
/// selections.
pub const REASON_SYNC_CONTRIBUTION_FEW_PREPARES: Reason = Reason {
...
/// were submitted.
pub const REASON_SYNC_CONTRIBUTION_ZERO_PREPARES: Reason = Reason {
...
pub const REASON_SYNC_CONTRIBUTION_FAILED_PREPARE: Reason = Reason {
...
/// received.
pub const REASON_SYNC_CONTRIBUTION_NO_EXTERNAL_PREPARES: Reason = Reason {
...
pub const REASON_NO_CONSENSUS: Reason = Reason {
    code: "no_consensus",
...
pub const REASON_NO_PEER_SIGNATURES: Reason = Reason {
...
pub const REASON_INSUFFICIENT_PEER_SIGNATURES: Reason = Reason {
...
pub const REASON_BROADCAST_BN_ERROR: Reason = Reason {
...
pub const REASON_BUG_PAR_SIG_DB_EXTERNAL: Reason = Reason {
...
pub const REASON_BUG_AGGREGATION_ERROR: Reason = Reason {
...
pub const REASON_BUG_DUTY_DB_ERROR: Reason = Reason {
...
pub const REASON_BUG_PAR_SIG_DB_INTERNAL: Reason = Reason {
