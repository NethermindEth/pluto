...
use pluto_eth2api::{
    ...
    PostStateValidatorsResponse, ValidatorRequestBody, spec::phase0::BLSPubKey,
};
...
impl Handler for Component {
    ...
    async fn validators(
        ...
        let request = PostStateValidatorsRequest::builder()
            .state_id(opts.state.clone())
            .body(body)
            .build()
            .map_err(|err| {
                ApiError::new(StatusCode::BAD_REQUEST, "invalid validators request")
                    .with_boxed_source(err.into())
            })?;
...
mod tests {
    ...
    use pluto_eth2api::{
        GetStateValidatorsResponseResponse, ValidatorResponseValidator, ValidatorStatus,
    };
    use wiremock::{
    ...
    fn make_component_with_upstream(
        ...
        Component::new(eth2_cl, dutydb, 1, pub_share_by_pubkey, false)
    }
