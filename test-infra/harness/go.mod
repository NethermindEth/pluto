module github.com/NethermindEth/pluto/test-infra/harness
...
require (
	...
	github.com/obolnetwork/charon v1.7.1
...
// Charon's go.mod uses these forks via replace directives, which Go does not
// propagate to consumers - they must be copied verbatim or the harness
// compiles against the wrong upstream libraries.
replace github.com/coinbase/kryptology => github.com/ObolNetwork/kryptology v0.1.0

replace github.com/attestantio/go-eth2-client => github.com/ObolNetwork/go-eth2-client v0.27.1-obol.1
