...
// TmplNode represents a charon or pluto TmplNode service in a docker-compose.yml.
type TmplNode struct {
	Image      string // Image is a full image reference, empty by default, resulting in obolnetwork/charon:{CharonImageTag} being used.
