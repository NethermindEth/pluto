module github.com/NethermindEth/pluto/test-infra/compose
...
// Copied from charon v1.7.1 go.mod (Go does not propagate a dependency's replaces).
// Keep in sync when bumping the charon version.
