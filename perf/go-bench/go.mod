module github.com/nethermindeth/pluto/perf-bench
...
require (
	...
	github.com/obolnetwork/charon v0.0.0
...
replace github.com/obolnetwork/charon => ../../charon

// Charon's own replace directives must be mirrored here because replace
// directives only take effect in the main module, never transitively.
